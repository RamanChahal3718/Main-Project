...
function team_init(){
  ...
  function cmsclass_widgets_init() {
	...
	register_sidebar(array(
		...
		'description' => __( 'The first footer widget', 'cmsclass' ),
	...
	register_sidebar(array(
		...
		'description' => __( 'The second footer widget', 'cmsclass' ),
		'before_widget' => '<div class="logo-widget">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4>',
	...
	register_sidebar(array(
		...
		'description' => __( 'The third footer widget', 'cmsclass' ),
		'before_widget' => '<div class="logo-widget">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4>',
	...
	register_sidebar(array(
		...
		'description' => __( 'The fourth footer widget', 'cmsclass' ),
		'before_widget' => '<div class="logo-widget">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4>',
  ...
  /********Action hooks for single product page */
  add_action('woocommerce_before_single_product_summary', function(){
	printf(format: '<h4>This is our First PHP action Hook!!!</h4>');
  });
